...
The wider view needs explicit review by the approval team. The D17 submission asks whether a narrower scope or additional limits are needed; it does not establish acceptance. See [native mapping](native-mapping.md) and [release validation](validation.md) for restoration, compatibility and testing details.
